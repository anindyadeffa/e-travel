        ...
        <div class="row justify-content-center">
            <div class="col-xl-3 mb-2">
                <div class="card-travel text-center d-flex flex-column" style="background-image: url(img/bali.jpg);">
                    ...
                    <div class="mt-auto">
                        <a href="#" class="btn btn-view-more font-weight-bold px-4 mb-3">
                            View Details
                        </a>
                    </div>
                </div>
...
<section>
    <div class="container my-5">
        <div class="row d-flex mt-2">
            ...
            <div class="col-xl-6 my-5">
                <h1 style="color: #F5C234; font-size: 25px; font-weight: 600;">TRANSPORTATION</h1>
                <p class="text-grey-400" style="font-size: 16px;">Transportation is the act of moving something from one place to another. Transportation may take place by air, water, rail, road, pipeline, or cable routes, using planes, boats, trains, trucks, and telecommunications equipment as the means of transportation.</p>
            </div>
        </div>
        <div class="row d-flex mt-2">
            <div class="col-xl-6 my-5">
